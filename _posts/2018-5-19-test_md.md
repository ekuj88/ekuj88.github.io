...
Note right of Bob: Bob thinks1111111
Bob1-->Alice: I am good thanks!
```
...
<i class="icon-list"></i>fwfwef
<i class="icon-"></i>目录：快速导航当前文稿的目录结构以跳转到感兴趣的段落
...
[^LaTeX]: 支持 **LaTeX** 编辑显示支持，例如：$\sum_{i=1}^n a_i=0$， 访问 [MathJax][6] 参考更多使用方法。
